package com.miadfm.podcasts.ui.recent
...
fun RecentScreen(
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            PudiobookTopBar(
                subtitle = strings.navRecent
            )

            if (uiState.recentEpisodes.isEmpty()) {
                // Empty state
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                    ...
                    Column(
                        ...
                        Text(
                            text = strings.noRecentPodcastsSubtitle,
                ...
                // Recent episodes list (maximum 5 items)
                LazyColumn(
                    modifier = Modifier
                        .fillMaxWidth()
                        .weight(1f)
